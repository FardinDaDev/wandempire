	...
	public void onCast(final Player p) {
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				InstantFirework.createFireworkEffect(next.getLocation(), FireworkEffect.builder().with(Type.BURST).withColor(Color.LIME).withFade(Color.BLACK).flicker(true).trail(true).build());
